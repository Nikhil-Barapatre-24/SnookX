    ...
    <section id="find-us" className="py-24 lg:py-32 bg-[#060a0e]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-stretch">
          ...
          {/* Map */}
          <RevealOnScroll className="reveal-left" extraClass="lg:col-span-3 rounded-2xl overflow-hidden border border-[#1e3048] min-h-[360px] relative">
            <iframe
          ...
          {/* Info cards */}
          <RevealOnScroll className="reveal-right" extraClass="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            {INFO.map(({ icon, label, value, accent, bg }, i) => (
              <div
                key={label}
                className="group flex gap-4 p-5 rounded-2xl bg-[#0d1520] border border-[#1e3048]
                  hover:border-[#2e4a68] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
              >
                <div className={`flex-shrink-0 w-10 h-10 rounded-xl ${bg} ${accent} flex items-center justify-center transition-transform duration-200 group-hover:scale-110`}>
                  {icon}
                </div>
                <div>
            ...
            <a
              ...
              className="group flex items-center justify-center gap-2 p-4 rounded-2xl border border-dashed border-[#2e4a68]
