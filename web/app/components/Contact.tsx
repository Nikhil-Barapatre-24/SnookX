...
const SOCIAL = [
  ...
  },
  {
    ...
    color: "hover:text-green-400 hover:border-green-400/40 hover:bg-green-500/5",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section id="contact" className="py-24 lg:py-32 bg-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          ...
          {/* ── Left: info + socials ── */}
          <RevealOnScroll className="reveal-left" extraClass="lg:col-span-2 space-y-8">
            {/* Contact details */}
              ...
              {[
                {
                  ...
                  accent: "bg-green-900/20 text-green-400",
                },
                {
                  icon: (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  accent: "bg-amber-900/20 text-amber-400",
                },
                {
                  icon: (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  accent: "bg-blue-900/20 text-blue-400",
                },
              ].map(({ icon, label, accent }) => (
                <div key={label} className="flex items-start gap-3">
                  <span className={`flex-shrink-0 w-8 h-8 rounded-lg ${accent} flex items-center justify-center mt-0.5`}>
                    {icon}
                  </span>
            ...
            {/* Social links */}
            <div>
              <p className="text-xs font-semibold tracking-widest uppercase text-slate-500 mb-4">Follow Us</p>
                ...
                {SOCIAL.map(({ name, href, icon, color }) => (
                  <a
                    ...
                    className={`w-11 h-11 rounded-xl border border-[#1e3048] bg-[#0d1520]
                      ...
                      transition-all duration-200 hover:scale-110 hover:-translate-y-0.5 ${color}`}
                  >
                    {icon}
                  </a>
                ))}
            ...
            {/* Hours callout */}
            <div className="p-5 rounded-2xl bg-[#0d1520] border border-[#1e3048] animate-border-glow">
          ...
          {/* ── Right: contact form ── */}
          <RevealOnScroll className="reveal-right" extraClass="lg:col-span-3">
            <div className="p-8 rounded-2xl bg-[#0d1520] border border-[#1e3048]">
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-12 text-center gap-4">
                  <div className="w-16 h-16 rounded-full bg-felt/20 flex items-center justify-center animate-pulse-glow">
                ...
                <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="group relative w-full py-3.5 rounded-xl bg-gradient-to-r from-green-700 to-green-600
